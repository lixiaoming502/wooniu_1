...
function doSearch(){
var str=document.getElementById("bdcsMain").value;if(str!="" && str!="可搜书名和作者，请您少字也别输错字。"){ location.href="https://m.xiaoshuoli.com/s3s.php?keyword="+str;}else{alert("请输入关键字！");}
}

function _17mb_top(){}
function _17mb_middle(){}
function _17mb_bottom(){
document.writeln("<script src=\'https://e.vouky.com/614021/1/0.xhtml?\'></script>");
}
function _17mb_xuanfu(){
document.writeln("<script src=\'https://m.vouky.com/25087.html?\'></script> ");
}